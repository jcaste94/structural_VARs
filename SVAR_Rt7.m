...
nirfsign = 7;  % horizon for IRF restrictions ==> restrict IRFs on impact and 6 quarter after the shock
...
for i=1:nvar
    ...
    saveas(gcf, strcat('pRt7_',figure_list{i},'.pdf'));
...
set(gcf, 'PaperPosition',[xMargin yMargin xSize ySize])
set(gcf, 'PaperOrientation','portrait')  
saveas(gcf,'pRt7_DistributionTheta.pdf');
